...
$lang_array = array(
  ...
  'TEXT_PAYPAL_TRACKING_SUBMIT' => 'Ajouter un num&eacute;ro d\'envoi',
   ...
   'TEXT_PAYPAL_CREATE_PRODUCT' => 'Cr&eacute;er un article',
   
   
   // subscriptions
   'TEXT_PAYPAL_SUBSCRIPTIONS_HEADING' => 'Abonnement PayPal',
   'TEXT_PAYPAL_PLANS' => 'Plan',
   'TEXT_PAYPAL_NEW_PLAN' => 'Nouveau plan',
   'TEXT_PAYPAL_PLAN_SAVE' => 'Cr&eacute;er un plan',
   'TEXT_PAYPAL_PLAN_PATCH' => 'Mettre &agrave; jour le plan',
   'TEXT_PAYPAL_PLAN_STATUS' => 'Statut',
   'TEXT_PAYPAL_PLAN_NAME' => 'D&eacute;signation',
   'TEXT_PAYPAL_PLAN_DAY_NAME_INFO' => 'La d&eacute;signation est affich&eacute;e au client et ne peut plus &ecirc;tre modifi&eacute;e.',
   'TEXT_PAYPAL_PLAN_INTERVAL' => 'Paiement',
   'TEXT_PAYPAL_PLAN_CYCLE' => 'Dur&eacute;e de validit&eacute;',
   'TEXT_PAYPAL_PLAN_CYCLE_NO_LIMIT' => 'jusqu\'&agrave; nouvel ordre',
   'TEXT_PAYPAL_PLAN_FIXED_PRICE' => 'Prix',
   'TEXT_PAYPAL_PLAN_SETUP_FEE' => 'B&acirc;timent d\'installation',
   'TEXT_PAYPAL_PLAN_TAX_CLASS' => 'Classe d\'imp&ocirc;t',
   'TEXT_PAYPAL_PLAN_TAX_INCLUDE' => 'Taxe incluse',
   
   'TEXT_PAYPAL_PLAN_DAY' => 'Jour apr&egrave;s jour',
   'TEXT_PAYPAL_PLAN_WEEK' => 'Chaque semaine',
   'TEXT_PAYPAL_PLAN_MONTH' => 'Mensuel',
   'TEXT_PAYPAL_PLAN_YEAR' => 'Annuellement',
   
   'TEXT_PAYPAL_NO_CHANGE' => 'ne peut plus &ecirc;tre modifi&eacute;',
   'TEXT_ACTIVE' => 'Activ&eacute;',
   'TEXT_INACTIVE' => 'D&eacute;sactiv&eacute;',
 
   'TEXT_NONE' => '--pas de--',
   'TEXT_YES' => 'oui',
   'TEXT_NO' => 'non',
   
   'TEXT_PAYPAL_BILLING' => 'Paiements',
   'TEXT_PAYPAL_BILLING_OUTSTANDING' => 'montant en suspens:',
   'TEXT_PAYPAL_BILLING_CYCLES_COMPLETED' => 'Paiements effectu&eacute;s:',
   'TEXT_PAYPAL_BILLING_CYCLES_REMAINING' => 'Paiements en cours:',
   'TEXT_PAYPAL_BILLING_CYCLES_TOTAL' => 'Total des paiements:',
   'TEXT_PAYPAL_BILLING_TIME_NEXT' => 'Prochain paiement:',
   'TEXT_PAYPAL_BILLING_TIME_FINAL' => 'Dernier paiement:',
   'TEXT_PAYPAL_BILLING_FAILED' => '&Eacute;chec:',
   'TEXT_PAYPAL_CANCEL' => 'Annuler les paiements',
   'TEXT_PAYPAL_CANCEL_SUBMIT' => 'Confirmer',
  
  
  // error
  'TEXT_PAYPAL_ERROR_AMOUNT' => 'Veuillez saisir un montant.',
  'TEXT_PAYPAL_ERROR_ALREADY_PAID' => 'Nous avons d&eacute;j&agrave; re&ccedil;u votre paiement. Merci beaucoup!',
  'TEXT_PAYPAL_ERROR_NO_PLAN' => 'Veuillez choisir un plan.',
  'TEXT_PAYPAL_ERROR_MAX_PRODUCTS' => 'Cet article ne peut &ecirc;tre achet&eacute; que seul.',
  'TEXT_PAYPAL_ERROR_CANCEL' => 'Une erreur est survenue lors de l\'annulation.',
  'TEXT_PAYPAL_ERROR_SUBSCRIPTION_PRODUCTS' => 'Vous avez un article d\'abonnement dans votre panier qui ne peut &ecirc;tre achet&eacute; que seul.',
