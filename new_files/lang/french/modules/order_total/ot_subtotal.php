...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_ORDER_TOTAL_SUBTOTAL_TITLE_NO_TAX', 'Sous-total, pas de taxe');
  define('MODULE_ORDER_TOTAL_SUBTOTAL_DESCRIPTION', 'Sous-total de l\'ordre');

  define('MODULE_ORDER_TOTAL_SUBTOTAL_STATUS_TITLE','Afficher le sous-total');
