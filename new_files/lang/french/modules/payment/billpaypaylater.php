...
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO1', 'Merci d\'avoir choisi de payer avec PayLater. Les montants dus seront d&eacute;bit&eacute;s sur le compte indiqu&eacute; lors de la commande. En plus de cette facture, Billpay vous fournira prochainement un plan de paiement avec des informations d&eacute;taill&eacute;es sur vos versements.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO2', 'L\'ordre a &eacute;t&eacute; donn&eacute; par ');
...
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_PROMO', 'Cliquez sur le bouton radio pour en savoir plus.');
// OT
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_FEE', 'Frais de service');
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_TOTAL', 'Total + frais PayLater');
define('MODULE_PAYMENT_BILLPAY_GIROPAY_CANCELED', 'Giropay annul&eacute;');
...
// Plugin 1.7
define('MODULE_PAYMENT_BILLPAYPAYLATER_THANK_YOU_TEXT', 'Merci d\'avoir choisi BillPay PayLater Installment lors de votre achat.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_PAY_UNTIL_TEXT', 'Les montants dus seront d&eacute;bit&eacute;s mensuellement du compte suivant:');
define('MODULE_PAYMENT_BILLPAYPAYLATER_EMAIL_TEXT', 'En plus de la facture, vous recevrez prochainement un plan de paiement avec des informations d&eacute;taill&eacute;es sur vos paiements.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_TITLE', 'PayLater | Versement');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_DESCRIPTION', 'PayLater | Versement');
?>