...
define('MODULE_PAYMENT_PAYONE_PAYDIREKT_TEXT_DESCRIPTION', 'Paiement par PayDirekt via PayOne');
define('MODULE_PAYMENT_PAYONE_PAYDIREKT_TEXT_INFO', 'Paiement par portefeuille &eacute;lectronique (PayDirekt)');
