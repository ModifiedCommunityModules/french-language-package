...
define('MODULE_PAYMENT_PAYONE_CC_TEXT_TITLE', 'Cartes de cr&eacute;dit');
define('MODULE_PAYMENT_PAYONE_CC_TEXT_DESCRIPTION', 'Paiement par carte de cr&eacute;dit via PayOne');
define('MODULE_PAYMENT_PAYONE_CC_TEXT_INFO', 'Payez avec votre carte de cr&eacute;dit');
