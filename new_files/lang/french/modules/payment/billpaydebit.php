...
/* Default Messages */
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_TITLE', 'BillPay - D&eacute;bit direct');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_DESCRIPTION', 'BillPay - D&eacute;bit direct');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO1', 'Merci d\'avoir choisi de payer par pr&eacute;l&egrave;vement automatique avec BillPay. Nous allons d&eacute;biter le montant d&ucirc; dans les prochains jours.');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO2', 'L\'ordre a &eacute;t&eacute; &eacute;mis par ');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO1', 'Les frais de pr&eacute;l&egrave;vement automatique pour cette commande sont de ');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_TITLE', 'BillPay - D&eacute;bit direct');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_DESCRIPTION', 'BillPay - D&eacute;bit direct');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO1', 'Nous vous remercions d\'avoir choisi de payer par pr&eacute;l&egrave;vement automatique avec BillPay. Nous vous facturerons le montant d&ucirc; dans les prochains jours.');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO2', 'L\'ordre a &eacute;t&eacute; donn&eacute; par ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO3', '');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO1', 'Les frais de pr&eacute;l&egrave;vement automatique pour cet ordre sont de ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO2', '');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_EULA_CHECK', MODULE_PAYMENT_BILLPAY_TEXT_EULA_CHECK);
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_EULA_CHECK_DE', MODULE_PAYMENT_BILLPAY_TEXT_EULA_CHECK_CH);
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_SEPA_INFORMATION_AT', MODULE_PAYMENT_BILLPAY_TEXT_SEPA_INFORMATION_AT);
// Plugin 1.7
define('MODULE_PAYMENT_BILLPAYDEBIT_THANK_YOU_TEXT', 'Merci d\'avoir choisi la domiciliation BillPay lors de votre achat.');
define('MODULE_PAYMENT_BILLPAYDEBIT_PAY_UNTIL_TEXT', 'Nous d&eacute;biterons %1$s %2$s du compte suivant dans les prochains jours:');
define('MODULE_PAYMENT_BILLPAYDEBIT_EMAIL_TEXT', 'BillPay vous informera &agrave; l\'avance par e-mail de la date &agrave; laquelle votre compte sera d&eacute;bit&eacute;.');
?>