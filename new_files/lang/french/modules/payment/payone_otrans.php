...
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_TITLE', 'Transaction en ligne');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_DESCRIPTION', 'Paiement par transaction en ligne via PayOne');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_INFO', 'Paiement par transaction en ligne');
