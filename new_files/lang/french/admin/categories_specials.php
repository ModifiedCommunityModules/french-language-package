...
define ('TEXT_SPECIALS_NO_PID', 'L\'article doit d\'abord &ecirc;tre stock&eacute;, sinon la remise ne peut pas &ecirc;tre appliqu&eacute;e correctement');
define('TEXT_CATSPECIALS_START_DATE_TT', 'Indiquez la date &agrave; partir de laquelle le prix de l\'offre sera applicable.<br>');
