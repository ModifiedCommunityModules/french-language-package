...
define('TEXT_UNSET', 'r&eacute;voquer');
define('TEXT_SEND', 'Envoyer');
define('ERROR_PLEASE_SELECT_CUSTOMER_GROUP', 'Veuillez choisir au moins un groupe de clients');
define('ERROR_PLEASE_SELECT_SHOP_AREA', 'Veuillez choisir au moins une section de la boutique');
define('TEXT_CATEGORIES_SUCCESSFULLY_SET', 'Les autorisations de cat&eacute;gories ont &eacute;t&eacute; &eacute;tablies avec succ&egrave;s.');
define('TEXT_CATEGORIES_SUCCESSFULLY_UNSET', 'Autorisations de cat&eacute;gories supprim&eacute;es avec succ&egrave;s.');
define('TEXT_PRODUCTS_SUCCESSFULLY_SET', 'Les autorisations de produits ont &eacute;t&eacute; &eacute;tablies avec succ&egrave;s.');
