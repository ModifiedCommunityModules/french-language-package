...
class fs_french_language_package extends StdModule
{
  function __construct() 
  {
    $this->init('MODULE_FS_FRENCH_LANGUAGE_PACKAGE');
    $this->keys_dispnone = ['MODULE_FS_FRENCH_LANGUAGE_PACKAGE_STATUS'];
  }
  ...
  function getDescription()
  {
    ...
    $languages_id_query = xtc_db_query("SELECT languages_id, status, status_admin FROM languages WHERE code = 'fr'");
  ...
  {
    $stdLanguageModule = new StdLanguageModule;
    $stdLanguageModule->setLanguageIdByCode('fr');
